  ...
  return (
    <>
      <div>
        ...
        <div>
          <h1 className=" font-bold pl-[1vw] pt-5 pb-5 text-[4vw]">
            MEDAL WORTHY BRANDS TO BAG
          </h1>

          <div className=" w-full  pl-3 pr-3 grid grid-cols-4 text-[2.5vw]">
            <Link to="/product" state={{ category: "Clothes" }}>
              <div className="flex-col  ">
                <img
                  className=""
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRsiTy5XdI52BdnNCROxP8cA_JdRv5_Y4F0uA&usqp=CAU"
                  alt=""
                />
                <h1>Clothes</h1>
            ...
            <Link to="/product" state={{ category: "Electronics" }}>
              <div className="flex-col ">
                <img
                  className=""
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRBDMpAlJvlbciO5em4u21B89yiMny281qjqw&usqp=CAU"
                  alt=""
                />
                <h1>Electronics</h1>
            ...
            <Link to="/product" state={{ category: "Shoes" }}>
              <div className="flex-col ">
                <img
                  className=""
                  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTDfwpakzaVu0S5Ls_IVHwOQiZ8bLWMsZCxGA&usqp=CAU"
                  alt=""
                />
                <h1>Shoes</h1>
          ...
          <div><h1 className=" text-[4vh] font-bold   ml-[1vh] mt-8">Product</h1></div>
          <div className="">
            ...
            <div className="  grid justify-items-center sm: grid-cols-2 w-[100%] md:grid-cols-3">
              {product.map((data) => {
                return (
                  <>
                    <div className="bg bg-gray-50 p-5 rounded-lg my-3 mx-2 ">
                      <Link
                        to="/detail"

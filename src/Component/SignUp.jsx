...
function SignUp() {
  return (
   ...
   < div className="flex min-h-full flex-1 flex-col justify-center px-6 py-10 lg:px-8 bg-rose-100">
            ...
            <div>
              <div className="flex items-center justify-between">
                ...
                <div className="text-sm">
                  <a href="/" className="font-semibold text-rose-400 hover:text-rose-600">
                    Forgot password?
                  </a>
                </div>
              </div>
